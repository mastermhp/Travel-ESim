...
"[project]/Downloads/travel-e-sim-system/app/api/v1/agent/orders/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        let decoded;
        try {
            decoded = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token, process.env.JWT_SECRET || "your-secret-key");
        ...
        const agentOrdersCollection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"])("agentorders");
        const orders = await agentOrdersCollection.find({
            agentId: agent._id
        }).sort({
            createdAt: -1
        }).toArray();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96ee0baf._.js.map