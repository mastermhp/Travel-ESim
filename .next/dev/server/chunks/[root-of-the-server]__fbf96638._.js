...
"[project]/Downloads/travel-e-sim-system/app/api/v1/agent/change-password/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const testHash = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(currentPassword, 10);
        console.log("[v0] Test hash of input:", testHash);
        // Try comparing
        const bcryptResult = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(currentPassword, agent.password);
        console.log("[v0] bcrypt.compare result:", bcryptResult);
        // Also try comparing the test hash with input
        const testComparison = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(currentPassword, testHash);
        ...
        if (agent.password.startsWith("$2a$") || agent.password.startsWith("$2b$")) {
            isCurrentPasswordValid = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].compare(currentPassword, agent.password);
        } else {
        ...
        // Hash new password
        const hashedPassword = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(newPassword, 10);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fbf96638._.js.map