...
"[project]/Downloads/travel-e-sim-system/app/api/v1/admin/orders/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const plansCol = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCollection"])("plans");
                ...
                $addFields: {
                    ...
                    customerEmail: {
                        $ifNull: [
                            ...
                            {
                                $arrayElemAt: [
                                    "$agentOrderDetails.customerEmail",
                                    0
                                ]
                            }
                        ]
                    ...
                    customerPhone: {
                        $ifNull: [
                            ...
                            {
                                $arrayElemAt: [
                                    "$agentOrderDetails.customerPhone",
                                    0
                                ]
                            }
                        ]
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7e9d3d2b._.js.map