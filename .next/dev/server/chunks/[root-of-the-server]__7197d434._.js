...
async function GET(request) {
    try {
        ...
        const settlements = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$lib$2f$models$2f$settlement$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(filter).populate("agentId").sort({
            createdAt: -1
        });
...
async function POST(request) {
    try {
        ...
        console.log("[Admin] Processing settlement action:", {
            settlementId,
            action
        });
        const settlement = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$lib$2f$models$2f$settlement$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(settlementId).populate("agentId");
        if (!settlement) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        if (action === "approve") {
            ...
            const wallet = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$lib$2f$models$2f$agent$2d$wallet$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            ...
            await settlement.save();
            // Create ledger entry
            await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$travel$2d$e$2d$sim$2d$system$2f$lib$2f$models$2f$ledger$2d$entry$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
                agentId: settlement.agentId._id,
                type: "withdrawal",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7197d434._.js.map